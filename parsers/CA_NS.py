...
class extract_data(paeras_example):
    def _get_ns_info(self,requests_obj, logger: Logger):
        zone_key = "CA-NS"
    ...
    def fetch_production(self,
        ...
        production, imports = self._get_ns_info(session, logger)
    ...
    def fetch_exchange(self,
        ...
        _, imports = self._get_ns_info(session, logger)
...
if __name__ == "__main__":
    ...
    pprint(s.fetch_exchange("CA-NS", "CA-NB", logger=test_logger))
