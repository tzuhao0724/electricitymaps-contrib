...
class extract_data(paeras_example):
    def _find_pei_key(self,pei_list, sought_key):
        matching_item = [
            item
    ...
    def _get_pei_info(self,requests_obj):
        ...
        data = {
            "pei_load": self._find_pei_key(raw_data, "Total On-Island Load"),
            "pei_wind_gen": self._find_pei_key(raw_data, "Total On-Island Wind Generation"),
            "pei_fossil_gen": self._find_pei_key(
                raw_data, "Total On-Island Fossil Fuel Generation"
            ),
            "pei_wind_used": self._find_pei_key(raw_data, "Wind Power Used On Island"),
            "pei_wind_exported": self._find_pei_key(raw_data, "Wind Power Exported Off Island"),
    ...
    def fetch_production(self,
        ...
        pei_info = self._get_pei_info(requests_obj)
...
if __name__ == "__main__":
    ...
    print(s.fetch_exchange("CA-PE", "CA-NB"))
