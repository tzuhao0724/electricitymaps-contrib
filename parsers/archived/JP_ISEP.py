...
class extract_data(paeras_example):
    def get_data_ori(self,region, year, month, day):
    ...
    def fetch_production(self,
        ...
        df = self.get_data_ori(region, year, month, day)
...
if __name__ == "__main__":
    ...
    print(s.fetch_production(target_datetime=pd.Timestamp("2019-01-01")))
    print("fetch_consumption() ->")
    print(s.fetch_consumption(target_datetime=pd.Timestamp("2019-01-01")))
