...
class extract_data(paeras_example):
    def fetch_production(self,
        ...
        non_renewables_production: Dict[str, dict] = self.non_renewables_production_mix(
            zone_key, current_session
        )
        renewables_production: Dict[str, dict] = self.renewables_production_mix(
            zone_key, current_session
        )
        ...
        full_production_list = [
            {
                ...
                "zoneKey": zone_key,
                "production": self.merged_production_mix(
    ...
    def merged_production_mix(self,non_renewables_mix: dict, renewables_mix: dict) -> dict:
    ...
    def renewables_production_mix(self,zone_key: str, session: Session) -> Dict[str, dict]:
    ...
    def non_renewables_production_mix(self,zone_key: str, session: Session) -> Dict[str, dict]:
...
if __name__ == "__main__":
    ...
    print(s.fetch_exchange("AR", "PY"))
    print("fetch_exchange(AR, UY) ->")
    print(s.fetch_exchange("AR", "UY"))
    print("fetch_exchange(AR, CL-SEN) ->")
    print(s.fetch_exchange("AR", "CL-SEN"))
